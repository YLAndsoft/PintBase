...
public class DetailsPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public DetailsPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public DetailsPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DetailsPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void addTextTab(final int position, String title) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.details_tab_title_item_gift_layout,null);

        TextView details_tab_title_name  = view.findViewById(R.id.details_tab_title_name);
        details_tab_title_name.setText(title);
        details_tab_title_name.setGravity(Gravity.CENTER);
        details_tab_title_name.setSingleLine();

        TextView details_tab_title_number  = view.findViewById(R.id.details_tab_title_number);

        //details_tab_title_number.setBackground(ContextCompat.getDrawable(getContext(),R.drawable.home_list_item_frist_ad_score_shape));
        details_tab_title_number.setSingleLine();
    ...
    private void updateTabStyles() {
        for (int i = 0; i < tabCount; i++) {
            ...
            v1.setBackgroundResource(tabBackgroundResId);
            View text = v1.findViewById(R.id.details_tab_title_name);
            View numberTxt =v1.findViewById(R.id.details_tab_title_number);
            ...
            if (text instanceof TextView) {
                ...
                txt.setTypeface(tabTypeface, tabTypefaceStyle);
                //num.setTypeface(tabTypeface, tabTypefaceStyle);

                txt.setTextColor(tabTextColor);
                num.setTextColor(tabTextColor);
                ...
                if (i == selectedPosition) {
                    ...
                    num.setTextColor(selectedTabTextColor);
                }
            }
        }
    }
    public void updateTabStyles(int selectedPosition) {
        for (int i = 0; i < tabCount; i++) {
            View v1 = tabsContainer.getChildAt(i);
            v1.setBackgroundResource(tabBackgroundResId);
            View text = v1.findViewById(R.id.details_tab_title_name);
